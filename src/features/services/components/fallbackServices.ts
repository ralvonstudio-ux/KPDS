...
export const FALLBACK_SERVICES: Service[] = [
  {
    ...
    description: null,
    cover_image_url: "/images/seed/kpds-studio-wedding.webp",
    deliverables: [],
  ...
  },
  {
    ...
    description: null,
    cover_image_url: "/images/seed/kpds-studio-prewedding.webp",
    deliverables: [],
  ...
  },
  {
    ...
    description: null,
    cover_image_url: "/images/seed/kpds-studio-films.webp",
    deliverables: [],
  ...
  },
  {
    ...
    description: null,
    cover_image_url: "/images/seed/kpds-studio-haldi.webp",
    deliverables: [],
